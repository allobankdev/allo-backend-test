package com.thasya.frankfurter.runner;
...
import com.thasya.frankfurter.store.FinanceDataStore;
import com.thasya.frankfurter.runner.FinanceDataInitializer;
import com.thasya.frankfurter.strategy.*;
...
class FinanceDataInitializerIT {
    ...
    void shouldInitializeStoreWithAllResourceTypes() throws Exception {
        ...
        githubProps.setUsername("thasya07"); // ganti kalau username kamu beda

...
while application runner is being run after application context is fully loaded, and in this case we need to make an external call which need the application context to be fully ready.
